org.springframework.web.util.NestedServletException: Handler dispatch failed; nested exception is java.lang.NoSuchMethodError: com.credibanco.repository.IBinStagesRepository.updateBines(Ljava/lang/Long;Ljava/lang/String;)V
...
Caused by: java.lang.NoSuchMethodError: com.credibanco.repository.IBinStagesRepository.updateBines(Ljava/lang/Long;Ljava/lang/String;)V
	at com.credibanco.services.BinStagesService.updateBiness(BinStagesService.java:39) ~[classes/:na]
	at com.credibanco.controller.BinStagesController.updateBinesForEscenario(BinStagesController.java:50) ~[classes/:na]
...
Query
  ...
  @Transactional
    @Modifying
    @Query("UPDATE BinStages b set b.bines = :bines where b.idEscenario = :idEscenario")
    boolean updateBines(Long idEscenario,String bines);
