org.springframework.beans.factory.UnsatisfiedDependencyException: Error creating bean with name 'binStagesController': Unsatisfied dependency expressed through field 'binStagesService'; nested exception is org.springframework.beans.factory.UnsatisfiedDependencyException: Error creating bean with name 'binStagesService': Unsatisfied dependency expressed through field 'binStagesRepository'; nested exception is org.springframework.beans.factory.BeanCreationException: Error creating bean with name 'IBinStagesRepository' defined in com.credibanco.repository.IBinStagesRepository defined in @EnableJpaRepositories declared on PosApiFiladelfiaApplication: Invocation of init method failed; nested exception is org.springframework.data.repository.query.QueryCreationException: Could not create query for public abstract java.util.Optional com.credibanco.repository.IBinStagesRepository.updateBines(int,java.lang.String)! Reason: Using named parameters for method public abstract java.util.Optional com.credibanco.repository.IBinStagesRepository.updateBines(int,java.lang.String) but parameter 'Optional[escenario]' not found in annotated query 'BIN_STAGES b set b.BINES = :BINES where b.ESCENARIO = :ESCENARIO'!; nested exception is java.lang.IllegalStateException: Using named parameters for method public abstract java.util.Optional com.credibanco.repository.IBinStagesRepository.updateBines(int,java.lang.String) but parameter 'Optional[escenario]' not found in annotated query 'BIN_STAGES b set b.BINES = :BINES where b.ESCENARIO = :ESCENARIO'!
...
Caused by: org.springframework.data.repository.query.QueryCreationException: Could not create query for public abstract java.util.Optional com.credibanco.repository.IBinStagesRepository.updateBines(int,java.lang.String)! Reason: Using named parameters for method public abstract java.util.Optional com.credibanco.repository.IBinStagesRepository.updateBines(int,java.lang.String) but parameter 'Optional[escenario]' not found in annotated query 'BIN_STAGES b set b.BINES = :BINES where b.ESCENARIO = :ESCENARIO'!; nested exception is java.lang.IllegalStateException: Using named parameters for method public abstract java.util.Optional com.credibanco.repository.IBinStagesRepository.updateBines(int,java.lang.String) but parameter 'Optional[escenario]' not found in annotated query 'BIN_STAGES b set b.BINES = :BINES where b.ESCENARIO = :ESCENARIO'!
...
Caused by: java.lang.IllegalStateException: Using named parameters for method public abstract java.util.Optional com.credibanco.repository.IBinStagesRepository.updateBines(int,java.lang.String) but parameter 'Optional[escenario]' not found in annotated query 'BIN_STAGES b set b.BINES = :BINES where b.ESCENARIO = :ESCENARIO'!
